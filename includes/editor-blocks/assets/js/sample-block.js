...
( function() {
	...
	*/
	registerBlockType( 'ptp/sample-block', {
		title    : __( 'Sample Block', 'pt-plugin' ),
		icon     : 'lightbulb',
		category : 'common',

		// The "edit" property must be a valid function.
		edit: function(props) {
			// Creates a <p class='wp-block-ptp-sample-block"'></p>.
			return el(
				'p', // Tag type.
				{ className: props.className }, // The class="wp-block-ptp-sample-block" : The class name is generated using the block's name prefixed with wp-block-, replacing the / namespace separator with a single -.
