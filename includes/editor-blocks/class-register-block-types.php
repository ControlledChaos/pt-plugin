...
namespace PT_Plugin\Includes\Editor_Blocks;
...
class Register_Blocks {
	...
	public function block_editor_assets() {
		...
		wp_enqueue_script(
			'ptp-sample-block-script', // Handle.
			...
			filemtime( PTP_PATH . 'includes/editor-blocks/assets/js/sample-block.min.js' ) // filemtime — Gets file modification time.
		);

		// Sample block styles.
		wp_enqueue_style(
			'ptp-sample-block', // Handle.
			...
			filemtime( PTP_PATH . 'includes/editor-blocks/assets/css/sample-block.min.css' ) // filemtime — Gets file modification time.
		);
	...
	public function block_frontend_assets() {
		...
		wp_enqueue_style(
			...
			[ 'wp-blocks' ],
			filemtime( PTP_PATH . 'includes/editor-blocks/assets/css/sample-block.css' )
		);
