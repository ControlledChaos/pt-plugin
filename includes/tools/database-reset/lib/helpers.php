...
function db_reset_activation_checks() {
  if ( ! function_exists( 'spl_autoload_register' ) &&
    ...
    return __( 'The WordPress Database Reset plugin requires at least PHP 5.3!', 'pt-plugin' );
  }

  if ( version_compare( get_bloginfo( 'version' ), '3.0', '<' ) ) {
    return __( 'The WordPress Database Reset plugin requires at least WordPress 3.0!', 'pt-plugin' );
  }
