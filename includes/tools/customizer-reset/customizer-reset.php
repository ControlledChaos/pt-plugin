...
namespace PT_Plugin\Includes\Tools\Customizer_Reset;
...
final class Customizer_Reset {
	...
	public function customize_controls_print_scripts() {
		...
		wp_enqueue_script( 'ptp-customizer-reset', PTP_URL . 'includes/tools/customizer-reset/assets/js/customizer-reset.js', [ 'jquery' ], '20150120' );

		wp_localize_script( 'ptp-customizer-reset', '_PTPCustomizerReset', [
			'reset'   => __( 'Reset', 'pt-plugin' ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', 'pt-plugin' ),
			'nonce'   => [
