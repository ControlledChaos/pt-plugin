...
class Meta_Image {
	...
	public function __construct() {
		...
		add_action( 'ptp_meta_image_tag', [ $this, 'image' ] );
	...
	public function image() {
		...
		if ( ptp_acf_options() ) {
			...
			$blog_image    = get_field( 'ptp_meta_blog_image', 'option' );
			$default_image = get_field( 'ptp_meta_default_image', 'option' );
