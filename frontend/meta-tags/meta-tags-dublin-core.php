...
<!-- Dublin Core meta -->
<meta name="DC.Title" content="<?php esc_attr( do_action( 'ptp_meta_title_tag' ) ); ?>" />
<meta name="DC.Format" content="text/html" />
<meta name="DC.Identifier" content="<?php esc_attr( esc_url( do_action( 'ptp_meta_url_tag' ) ) ); ?>"/>
...
<?php else : ?>
<meta name="DC.Description" content="<?php esc_attr( do_action( 'ptp_meta_description_tag' ) ); ?>" />
<?php endif; ?>
...
<?php if ( is_singular() ) : ?>
<meta name="DC.Contributor" content="<?php esc_attr( do_action( 'ptp_meta_author_tag' ) ); ?>" />
<?php endif; ?>
<?php if ( is_single() ) : ?>
...
<meta name="DC.Rights" content="<?php echo esc_attr( sprintf( '© Copyright %1s %2s. %3s.', get_the_time( 'Y' ), get_bloginfo( 'name' ), esc_attr__( 'All rights reserved', 'pt-plugin' ) ) ); ?>" />
