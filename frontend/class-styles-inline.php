...
class Inline_Frontend_Styles {
	...
	public function styles() {
		...
		$fancybox    = file_get_contents( esc_html( PTP_PATH . 'assets/css/jquery.fancybox.min.css' ) );
		$slick       = file_get_contents( esc_html( PTP_PATH . 'assets/css/slick.min.css' ) );
		$slick_theme = file_get_contents( esc_html( PTP_PATH . 'assets/css/slick-theme.min.css' ) );
		$tooltipster = file_get_contents( esc_html( PTP_PATH . 'assets/css/tooltipster.bundle.min.css' ) );
 ...
 */
function ptp_inline_frontend_styles() {
