...
class Inline_Frontend_Scripts {
	...
	public function scripts() {
		...
		$fancybox    = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/jquery.fancybox.min.js' ) );
		$slick       = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/slick.min.js' ) );
		$tabslet     = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/jquery.tabslet.min.js' ) );
		$tooltipster = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/tooltipster.bundle.min.js' ) );
		$stickykit   = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/sticky-kit.min.js' ) );
		$fitvids     = file_get_contents( esc_html( PTP_PATH . 'frontend/assets/js/jquery.fitvids.min.js' ) );
		...
		// Sticky-kit.
		if ( get_option( 'ptp_enqueue_stickykit' ) ) {
 ...
 */
function ptp_inline_frontend_scripts() {
