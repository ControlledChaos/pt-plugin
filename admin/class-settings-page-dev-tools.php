...
class Settings_Page_Dev_Tools {
	...
	public function settings_page() {
		...
		$this->page_help_section = add_management_page(
			__( 'Website Development', 'pt-plugin' ),
			__( 'Site Development', 'pt-plugin' ),
			'manage_options',
			PTP_ADMIN_SLUG . '-dev-tools',
			[ $this, 'page_output' ]
		);
	...
	public function page_output() {
		...
		require PTP_PATH . 'admin/partials/settings-page-development.php';
	...
	public function help_dev_info_output() {
		...
		include_once PTP_PATH . 'admin/partials/help/help-dev-info.php';
 ...
 */
function ptp_settings_page_dev_tools() {
