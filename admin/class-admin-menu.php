...
class Admin_Menu {
    ...
    public function __construct() {
        ...
        if ( ptp_acf_options() ) {
            ...
            $options = get_field( 'ptp_admin_hide_links', 'option' );
        ...
        // Get links option.
        if ( ptp_acf_options() ) {
            $links = get_field( 'ptp_links_manager', 'option' );
        } else {
            $links = get_option( 'ptp_hide_links' );
        }
    ...
    public function hide() {
        ...
        if ( ptp_acf_options() ) {
            ...
            // Get options.
            $appearance = get_option( 'ptp_hide_appearance' );
            $plugins    = get_option( 'ptp_hide_plugins' );
            $users      = get_option( 'ptp_hide_users' );
            $tools      = get_option( 'ptp_hide_tools' );
    ...
    public function menus_widgets() {
        ...
        if ( ptp_acf_options() ) {
            ...
            $menus_link   = get_field( 'ptp_menus_position', 'option' );
            $widgets_link = get_field( 'ptp_widgets_position', 'option' );
        ...
        // If ACF is not active.
            ...
            $menus_link   = get_option( 'ptp_menus_position' );
            $widgets_link = get_option( 'ptp_widgets_position' );
