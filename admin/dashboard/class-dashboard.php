...
class Dashboard {
	...
	private function dependencies() {
        ...
        require PTP_PATH . 'admin/dashboard/class-dashboard-widget.php';

        // Get the welcome panel class.
        require PTP_PATH . 'admin/dashboard/class-welcome.php';
    ...
    public function metaboxes() {
        ...
        if ( ptp_acf_options() ) {
            ...
            $hide = get_field( 'ptp_dashboard_hide_widgets', 'option' );
        ...
        // If Advanced Custom Fields is not active.
            ...
            // Get options.
            $welcome    = get_option( 'ptp_hide_welcome' );
            $gutenberg  = get_option( 'ptp_hide_try_gutenberg' );
            $editor     = get_option( 'ptp_classic_editor' );
            $wp_news    = get_option( 'ptp_hide_wp_news' );
            $quickpress = get_option( 'ptp_hide_quickpress' );
            $at_glance  = get_option( 'ptp_hide_at_glance' );
            $activity   = get_option( 'ptp_hide_activity' );
    ...
    public function add_help() {
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Welcome Panel', 'pt-plugin' ),
			'content'  => null,
		...
		$screen->add_help_tab( [
			...
			'title'    => __( 'Dashboard Widgets', 'pt-plugin' ),
			'content'  => null,
	...
	public function help_welcome_panel() {
        ...
        include_once PTP_PATH . 'admin/dashboard/partials/help/help-welcome-panel.php';
	...
	public function help_dashboard_widgets() {
        ...
        include_once PTP_PATH . 'admin/dashboard/partials/help/help-dashboard-widgets.php';
    ...
    public function help_dashboard_sidebar() {
        ...
        $html  = sprintf(
            '<h4>%1s %2s</h4>',
            __( 'Custom Dashboard for', 'pt-plugin' ),
             get_bloginfo( 'name' )
        );
	...
	public function styles() {
        ...
        if ( $screen->id == 'dashboard' ) {
            wp_enqueue_style( PTP_ADMIN_SLUG . '-dashboard', PTP_URL .  'admin/dashboard/assets/css/dashboard.min.css', [], null, 'screen' );
        }
