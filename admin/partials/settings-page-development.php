...
$page_tabs = apply_filters( 'ptp_tabs_development', $tabs );
...
if ( 'general' == $active_tab ) {
    $section = 'ptp-site-development-general';
    $fields  = 'ptp-site-development-general';
} else {
    $section = null;
    $fields  = null;
}
...
$do_section = apply_filters( 'ptp_section_development', $section );
$do_fields  = apply_filters( 'ptp_fields_development', $fields );
...
<div id="setting-error-settings_updated" class="notice notice-success is-dismissible">
	<p><strong><?php _e( 'Settings saved.', 'pt-plugin' ); ?></strong></p>
</div>
<?php } ?>
<div class="wrap">
	<?php echo sprintf( '<h1 class="wp-heading-inline">%1s %2s</h1>', get_bloginfo( 'name' ), esc_html__( 'Development', 'pt-plugin' ) ); ?>
	<p class="description"><?php _e( 'A few tools that come in handy during the development of your website.', 'pt-plugin' ); ?></p>
